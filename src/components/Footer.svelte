...
>
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        ...
        <p>
            ...
            <a href="mailto:juantarratla@gmail.com" class="text-violet-400">juantarratla@gmail.com</a>
        </p>
        <p>
            <b class="pr-2">GitHub</b>
            <a href="https://github.com/juanxTLA" target="_blank" class="text-violet-400"
                >juanxTLA<sup class=""
        ...
        <p>
            ...
            <a href="https://www.linkedin.com/in/juan-tarrat-a9b29119a/" target="_blank" class="text-violet-400"
                >Juan Tarrat<sup class=""
                    ><span class="text-xs scale-75 pl-0.5"
                        ><i
                            class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"
                        /></span
