...
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<footer class="py-20 sm:py-32 bg-black border-t border-solid border-violet-950 flex flex-col gap-4 sm:gap-8 justify-center items-center" data-svelte-h="svelte-1y77r1g"><p class="px-4 py-2 bg-white text-slate-950 font-medium">Connect with me ↓</p> <div class="flex flex-col gap-4 items-center justify-center"> <p><b class="pr-2">Email</b> <a href="mailto:juantarratla@gmail.com" class="text-violet-400">juantarratla@gmail.com</a></p> <p><b class="pr-2">GitHub</b> <a href="https://github.com/juanxTLA" target="_blank" class="text-violet-400">juanxTLA<sup class=""><span class="text-xs scale-75 pl-0.5"><i class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"></i></span></sup></a></p> <p><b class="pr-2">LinkedIn</b> <a href="https://www.linkedin.com/in/juan-tarrat-a9b29119a/" target="_blank" class="text-violet-400">Juan Tarrat<sup class=""><span class="text-xs scale-75 pl-0.5"><i class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"></i></span></sup></a></p></div></footer>`;
});
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<header${add_attribute(
    ...
    0
  )}><h1 class="font-medium" data-svelte-h="svelte-11c1sra"><b class="font-bold poppins">Juan</b> <span class="">Tarrat</span></h1> <div class="sm:flex items-center gap-4 hidden">${each(tabs, (tab, index) => {
  ...
  })}  <a href="https://www.linkedin.com/in/juan-tarrat-a9b29119a/" target="_blank" data-svelte-h="svelte-1gdpwnn"><button class="blueShadow relative overflow-hidden px-5 py-2 group rounded-full bg-white text-slate-950"><div class="absolute top-0 right-full w-full h-full bg-violet-400 opacity-20 group-hover:translate-x-full z-0 duration-200"></div> <h4 class="relative z-9">Get in touch</h4></button></a></div></header>`;
});
